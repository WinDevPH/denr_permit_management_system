...
<head>
    ...
    <title>Verify Permits - DENR</title>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-content admin-dashboard admin-permits">
                <header class="admin-dashboard-header">
                    <div>
                        <h1 class="admin-dashboard-title">Verify Permits</h1>
                        <p class="admin-dashboard-subtitle">Verify and approve or reject permit applications</p>
                    </div>
                </header>
