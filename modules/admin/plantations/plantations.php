...
<head>
    ...
    <title>Plantations - Admin Dashboard</title>
...
<body class="admin-plantations-page">
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <!-- Land Area / Plantations Content (same layout as Manage Users) -->
            <div class="dashboard-content admin-dashboard admin-plantations">
                <header class="admin-dashboard-header">
                    <div>
                        <h1 class="admin-dashboard-title">Plantations</h1>
                        <p class="admin-dashboard-subtitle">Monitor and manage tree plantation registrations</p>
                    </div>
                    <a href="register_plantation.php" class="btn btn-primary"><i class="fas fa-plus"></i> Register plantation (admin)</a>
                </header>
                ...
                <div class="admin-stats-row">
                    <div class="admin-stat-item">
                        ...
                        <div class="stat-content">
                            ...
                            <span class="stat-label">Total Plantations</span>
                        </div>
                    </div>
                    <div class="admin-stat-item">
                        ...
                        <section class="modal-section modal-section-actions" aria-labelledby="reviewFormHeading">
                            ...
                            <div class="form-grid form-grid-review">
                                ...
                                <div class="form-group form-group-full">
                                    <label class="form-label" for="remarksArea">Notes</label>
                                    <textarea name="remarks" id="remarksArea"
                                        class="form-control modern-input modern-textarea" rows="3"
                                        placeholder="Add feedback or remarks (optional)"></textarea>
                                </div>
                            </div>
                        </section>
                    </div>
    ...
    function reviewPlantation(plantation) {
        ...
        const reviewModal = window.adminReviewModal || (window.adminReviewModal = new bootstrap.Modal(reviewModalEl, { backdrop: true, keyboard: true }));
