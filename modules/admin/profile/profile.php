...
$admin_img = $admin['profile_img'] ?? 'default.png';
$admin_img_path = __DIR__ . '/../../../assets/uploads/profiles/' . $admin_img;
$has_image = ($admin_img !== 'default.png' && !empty($admin_img) && file_exists($admin_img_path));
$initials = 'U';
                        ...
                        <div class="profile-hero">
                            <div class="profile-hero-avatar-wrap">
                                ...
                                <label for="profileUpload" class="profile-hero-avatar" id="profileHeroAvatar" tabindex="0" aria-label="Change profile photo">
                                    <?php if ($has_image): ?>
                                    <img id="profileImage" src="../../../assets/uploads/profiles/<?php echo htmlspecialchars($admin_img); ?>" alt="" onerror="this.style.display='none'; var p=document.getElementById('profileImagePlaceholder'); if(p) p.style.display='flex';">
                            ...
                            <div class="profile-hero-info">
                                <h3 class="profile-hero-name" id="profileDisplayName"><?php echo htmlspecialchars($admin['full_name'] ?? 'User'); ?></h3>
                                <div class="profile-hero-role-wrap">
                                    <i class="fas fa-shield-alt profile-hero-role-icon"></i>
                                    <span class="profile-hero-role"><?php echo htmlspecialchars(ucfirst($admin['role'] ?? 'admin')); ?></span>
                                </div>
                                <ul class="profile-hero-details" aria-label="Profile details">
                                    <li class="profile-hero-detail-item">
                                        ...
                                        <span class="profile-hero-detail-value profile-hero-detail-value--email"><?php echo htmlspecialchars($admin['email'] ?? '—'); ?></span>
                                    </li>
                                    <li class="profile-hero-detail-item">
                                        <div class="profile-hero-detail-head">
                                        ...
                                        <span class="profile-hero-detail-value"><?php echo !empty($admin['created_at']) ? date('F j, Y', strtotime($admin['created_at'])) : '—'; ?></span>
                                    </li>
                                    <li class="profile-hero-detail-item">
                                        <div class="profile-hero-detail-head">
                                            <i class="fas fa-file-check profile-hero-detail-icon"></i>
                                            <span class="profile-hero-detail-label">Permits reviewed</span>
                                        </div>
                                    ...
                                    <li class="profile-hero-detail-item">
                                        <div class="profile-hero-detail-head">
                                            ...
                                            <span class="profile-hero-detail-label">Plantations reviewed</span>
                                        </div>
                            ...
                            <div class="profile-form-block">
                                ...
                                <div class="profile-form-grid">
                                    <div class="profile-form-row">
                                        ...
                                        <input type="text" id="fullName" name="full_name" value="<?php echo htmlspecialchars($admin['full_name'] ?? ''); ?>" required maxlength="120" autocomplete="name">
                                    </div>
                                    <div class="profile-form-row">
                                        <label for="email"><i class="fas fa-envelope profile-form-label-icon"></i> Email</label>
                                        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($admin['email'] ?? ''); ?>" required maxlength="120" autocomplete="email">
                                    </div>
                                    <div class="profile-form-row">
                                        <label for="phone"><i class="fas fa-phone profile-form-label-icon"></i> Phone</label>
                                        <input type="tel" id="phone" name="contact_number" value="<?php echo htmlspecialchars($admin['contact_number'] ?? ''); ?>" maxlength="20" autocomplete="tel">
                                    </div>
                                    <div class="profile-form-row">
                                        <label><i class="fas fa-shield-alt profile-form-label-icon"></i> Role</label>
                                        <input type="text" value="<?php echo htmlspecialchars(ucfirst($admin['role'] ?? '')); ?>" disabled class="profile-form-input-disabled">
